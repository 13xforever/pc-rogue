...
/*bool jump = FALSE;                  /* Show running as seriess of jumps */
...
char *s_guess[MAXSCROLLS];          /* Player's guess at what scroll is */
char *p_guess[MAXPOTIONS];          /* Player's guess at what potion is */
char *r_guess[MAXRINGS];            /* Player's guess at what ring is */
char *ws_guess[MAXSTICKS];          /* Player's guess at what wand is */
...
int fung_hit = 0;                   /* Number of times fungi has hit */
...
struct monster monsters[26] = {
    ...
    { "troll",              50,       ISMEAN|ISREGEN, { xx,  120,    6,  4, ___,     "1d8/1d8/2d6" } },
    { "ur-vile",             0,               ISMEAN, { xx,  190,    7, -2, ___, "1d3/1d3/1d3/4d6" } },
    { "vampire",            20,       ISMEAN|ISREGEN, { xx,  350,    8,  1, ___,            "1d10" } },
