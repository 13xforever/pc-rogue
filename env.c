/*
 * Env.c:   routines to se up environment
 *          Jon Lane - 10/31/83
 */
...
/*
 * setenf: read in environment from a file
 *
 *      envfile - name of file that contains data to be
 *                put in the environment
 *
 *      STATUS  - senenv return -1 if the file does not
 ...
 * efd (environment file desriptor)
 *
