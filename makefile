...
#
#       To disable stack overflow checking (thus getting a smidge more
#       speed), don't load in csav.o
#
OBJS=armor.0 new_leve.o command.o mach_dep.o croot.o main.o rip.o save.o \
