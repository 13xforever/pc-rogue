    ...
    char *msg;
{
    ...
    getxy(&x, &y);
    /*
     * it is reasonable to assume that if you are no longer
...
/*
 * putmsg:
 *      put a msg on the line, make sure htat it will fit, if it won't
 ...
 *      printf certainly '%' isn't a good choic eof characters. jll.
 */
str_attr(str)
    char *str;
{
...
SIG2()
{
    ...
    static int num1, caps1;
    static int nspot, cspot, tspot;
    register int new_num1, new_caps1, new_fmode;
    ...
    swint(SW_KEY, regs);
    new_num1 = regs->ax;
    new_caps1 = new_num1 & 0x40;
    new_fmode = new_num1 & 0x10;
    new_num1 &= 0x20;
    /*
 ...
 */
static int pf_str(), pf_chr(), pf_uint(), pf_int(), pf_perf();
