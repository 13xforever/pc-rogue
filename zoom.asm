...
codeseg semgent byte public 'code'
...
; LINES_ and COLS_should be set up too. If iscuron_ is set |
...
; damaged instruciton set won't let you do an IN to somewhere else.
;
        mov     cx,ax
        mov     dx,03dah
        cli
...
curch_  proc    near
        ...
        jz      goget
;
; We need to wait for retrace since this is no the super fast monochrome
; screen that we love so much. We have to save ax in cx since the brain
