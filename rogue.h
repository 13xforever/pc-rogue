 ...
 * Various flag bits
 */
#define ISDARK          0x000   /* room is dark */
#define ISGONE          0x000   /* room is gone (a corridor) */
#define ISMAZE          0x000   /* room is a maze */
...
union thing {
    ...
    struct {
        ...
        coord _o_pos;                   /* Where it lives on teh screen */
...
#define t_next          _t._t_next
#define t_prev          _t._t_prev
