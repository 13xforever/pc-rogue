 ...
 * All rights reserved
 * Copyright (C) 1983 by Mel Sibony, Jon Lane (AI Design update for the IBM PC)
 */
...
register int range;
{
    return range < 1 ? 0 : ((ran() + ran()) & 0x7ffffffffl) % range; 
}
...
quit()
{
    ...
    /*
     * if they try to interrupt with a control C while in
